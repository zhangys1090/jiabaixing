...
exports.API_CONTRACT = void 0;
exports.getContractGaps = getContractGaps;
exports.getContractStats = getContractStats;
exports.API_CONTRACT = [
    {
        method: 'GET',
        path: '/api/health',
        description: '健康检查',
...
function getContractGaps() {
    const tsOnly = exports.API_CONTRACT.filter((e) => e.tsImplemented && !e.pyImplemented);
    const pyOnly = exports.API_CONTRACT.filter((e) => e.pyImplemented && !e.tsImplemented);
    const both = exports.API_CONTRACT.filter((e) => e.tsImplemented && e.pyImplemented);
    return { tsOnly, pyOnly, both };
}
function getContractStats() {
    const gaps = getContractGaps();
    const aligned = gaps.both.length;
    const total = exports.API_CONTRACT.length;
    return {
        total,
