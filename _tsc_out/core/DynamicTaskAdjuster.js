...
class DynamicTaskAdjuster {
    ...
    isMonitoring = false;
    monitoringInterval;
    static ADJUSTMENT_HISTORY_MAX = 500;
    constructor(config) {
    ...
    executeAdjustment(decision) {
        ...
        if (this.adjustmentHistory.length > DynamicTaskAdjuster.ADJUSTMENT_HISTORY_MAX) {
            this.adjustmentHistory.splice(0, this.adjustmentHistory.length -
