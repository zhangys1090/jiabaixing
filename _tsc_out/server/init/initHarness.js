...
const AgentFactory_1 = require("../../harness/agents/AgentFactory");
...
async function initHarness(core, memoryEngine, sceneRecognizer) {
    ...
    try {
        ...
        AgentFactory_1.AgentFactory.injectExecuteFn(async (goal, context, _agent) => {
            const result = await core.processInput(goal, context || 'agent-factory');
            return result.response || '';
        });
        Logger_1.Logger.info('🏭 AgentFactory: 执行函数已注入', 'Bootstrap');
