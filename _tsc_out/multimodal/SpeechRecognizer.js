    ...
    async initialize() {
        ...
        try {
            ...
            try {
                ...
                Logger_1.Logger.info('faster-whisper 不可用，尝试 openai-whisper', 'SpeechRecognizer');
                try {
                    ...
                    Logger_1.Logger.warn('Whisper Python 环境均不可用，语音识别将运行在降级模式（返回空结果）', 'SpeechRecognizer');
                }
            }
