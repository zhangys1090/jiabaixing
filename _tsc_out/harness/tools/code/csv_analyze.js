...
exports.CSV_ANALYZE_DEF = void 0;
exports.createCsvAnalyzeExecutor = createCsvAnalyzeExecutor;
const types_1 = require("../../types");
const fs = __importStar(require("fs"));
exports.CSV_ANALYZE_DEF = {
    name: 'csv_analyze',
    description: '分析CSV文件，生成统计摘要和关键洞察。USE WHEN: 用户要求分析数据、查看CSV内容、生成数据报告。DO NOT USE WHEN: 用户要读取普通文本文件（用file_read）。返回行数、列数、每列统计、数据质量提示。',
...
function createCsvAnalyzeExecutor() {
