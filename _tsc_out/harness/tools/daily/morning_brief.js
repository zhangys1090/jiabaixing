...
exports.MORNING_BRIEF_DEF = void 0;
exports.createMorningBriefExecutor = createMorningBriefExecutor;
const Logger_1 = require("../../../utils/Logger");
const types_1 = require("../../types");
exports.MORNING_BRIEF_DEF = {
    name: 'morning_brief',
    description: '生成每日简报：自动搜索今日新闻、科技动态、天气等，汇总为结构化简报。USE WHEN: 用户要求晨报、每日简报、今日新闻摘要。DO NOT USE WHEN: 用户要搜索特定话题（用web_search）。',
...
function createMorningBriefExecutor(deps) {
            ...
            for (const topic of topics) {
                if (deps.searchExecutor) {
                    try {
                        ...
                        Logger_1.Logger.warn(`搜索 ${topic} 失败: ${err.message}`, 'MorningBrief');
                    }
                }
            }
...
4. 总字数控制在 300-500 字
5. 用 Markdown 格式输出`;
                const summary = await deps.llm.chat(prompt, [], '你是家百星的简报编辑模块，擅长简洁有力的中文表达。');
                return {
                    success: true,
                    output: summary,
                    duration: Date.now() - startTime,
