...
exports.TASK_DEPENDENCY_DEF = void 0;
exports.createTaskDependencyExecutor = createTaskDependencyExecutor;
const types_1 = require("../../types");
exports.TASK_DEPENDENCY_DEF = {
    name: 'task_dependency',
    description: '管理任务之间的依赖关系。支持设置前置任务、查看依赖链、检查阻塞状态、解除依赖等操作。适用场景：项目管理、任务编排、工作流管理。',
...
function formatDependencyChain(tasks, taskId, depth = 0) {
...
function createTaskDependencyExecutor(deps) {
