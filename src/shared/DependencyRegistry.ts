...
const SINGLETON_MIGRATION_MAP: SingletonMigrationEntry[] = [
  {
    ...
    token: DI_TOKENS.TIMER_MANAGER,
    module: '../utils/TimerManager',
    tags: [DI_TAGS.INFRASTRUCTURE],
    priority: 0,
    migrated: true,
  },
  {
    className: 'MemoryLeakGuard',
    token: DI_TOKENS.MEMORY_LEAK_GUARD,
    module: '../utils/MemoryLeakGuard',
    tags: [DI_TAGS.INFRASTRUCTURE],
    dependencies: [DI_TOKENS.TIMER_MANAGER],
    priority: 1,
    migrated: true,
  },
  {
    className: 'EnvironmentManager',
    token: DI_TOKENS.ENVIRONMENT_MANAGER,
  ...
  },
  {
    ...
    token: DI_TOKENS.SESSION_TOKEN_QUOTA,
    module: '../harness/constraints/SessionTokenQuota',
    tags: [DI_TAGS.CONSTRAINTS],
    priority: 2,
    migrated: true,
  },
  {
    className: 'SecurityPolicyEngine',
    token: DI_TOKENS.SECURITY_POLICY_ENGINE,
    module: '../security/SecurityPolicyEngine',
    tags: [DI_TAGS.SECURITY],
    priority: 1,
    migrated: true,
  },
  {
    className: 'SecurityGuard',
    token: DI_TOKENS.SECURITY_GUARD,
    module: '../security/SecurityGuard',
    tags: [DI_TAGS.SECURITY],
    dependencies: [DI_TOKENS.SECURITY_POLICY_ENGINE],
    priority: 2,
    migrated: true,
  },
  {
    className: 'UrlSafetyChecker',
    token: DI_TOKENS.URL_SAFETY_CHECKER,
  ...
  },
  {
    ...
    token: DI_TOKENS.MODEL_SELECTOR,
  ...
  },
  {
    ...
    token: DI_TOKENS.MESSAGE_SANITIZER,
  ...
  },
  {
    ...
    token: DI_TOKENS.PREFERENCE_MANAGER,
  ...
  },
  {
    ...
    token: DI_TOKENS.MCP_TOOL_BRIDGE,
  ...
  },
  {
    ...
    token: DI_TOKENS.LSP_CLIENT_MANAGER,
  ...
  },
  {
    ...
    token: DI_TOKENS.UNIFIED_CONTEXT_BUILDER,
    module: '../harness/context/UnifiedContextBuilder',
    tags: [DI_TAGS.HARNESS],
    priority: 2,
    migrated: true,
  },
  {
    className: 'SkillRegistry',
    token: DI_TOKENS.SKILL_REGISTRY,
  ...
  },
  {
    ...
    token: DI_TOKENS.ACP_ACTIVITY_TRACKER,
  ...
  },
  {
    ...
    token: DI_TOKENS.EVOLUTION_ENGINE,
    module: '../evolution/EvolutionOrchestrator',
    tags: [DI_TAGS.EVOLUTION],
    priority: 3,
    migrated: true,
  },
  {
    className: 'ImplicitFeedbackCollector',
    token: DI_TOKENS.IMPLICIT_FEEDBACK_COLLECTOR,
  ...
  },
  {
    ...
    token: DI_TOKENS.OPTIMIZATION_RESULT_DISPATCHER,
  ...
  },
  {
    ...
    token: DI_TOKENS.OPTIMIZATION_ADVISOR,
  ...
  },
  {
    ...
    token: DI_TOKENS.CRON_SCHEDULER,
  ...
  },
  {
    ...
    token: DI_TOKENS.PROFILE_TREND_ANALYZER,
  ...
  },
  {
    ...
    token: DI_TOKENS.MESSAGE_PROCESSOR,
  ...
  },
  {
    ...
    token: DI_TOKENS.SYSTEM_INIT_STATE,
  ...
  },
  {
    ...
    token: DI_TOKENS.DEVICE_DISCOVERY,
    module: '../hardware/DeviceDiscovery',
    tags: [DI_TAGS.DESKTOP],
    priority: 2,
    migrated: true,
  },
  {
    className: 'DesktopActionExecutor',
    token: DI_TOKENS.DESKTOP_ACTION_EXECUTOR,
  ...
  },
  {
    ...
    token: DI_TOKENS.DESKTOP_MCP_SERVER,
  ...
  },
  {
    ...
    token: DI_TOKENS.WINDOW_MANAGER,
  ...
  },
  {
    ...
    token: DI_TOKENS.UI_ELEMENT_PARSER,
  ...
  },
  {
    ...
    token: DI_TOKENS.SCREEN_CAPTURE,
  ...
  },
  {
    ...
    token: DI_TOKENS.NORMALIZED_COORDINATES,
  ...
  },
  {
    ...
    token: DI_TOKENS.DESKTOP_SKILL_REGISTRY,
...
export function getMigrationStats(): {
  ...
  migrated: number;
  pending: number;
  byTag: Record<string, { total: number; migrated: number }>;
} {
...
export async function registerCoreDependencies(): Promise<void> {
  ...
  if (!container.has(DI_TOKENS.MEMORY_LEAK_GUARD)) {
    ...
    container.register(
      ...
      async () => {
        ...
        return MemoryLeakGuard.create(
          tm as import('../utils/TimerManager').TimerManager
        );
      },
      {
        lifecycle: 'singleton',
  ...
  if (!container.has(DI_TOKENS.CONFIG_LOADER)) {
    ...
    container.register(DI_TOKENS.CONFIG_LOADER, () => ConfigLoader.create(), {
      lifecycle: 'singleton',
      tags: [DI_TAGS.INFRASTRUCTURE],
    });
  }
  ...
  if (!container.has(DI_TOKENS.EVENT_BUS)) {
    ...
    container.register(DI_TOKENS.EVENT_BUS, () => JiabaixingEventBus.create(), {
      lifecycle: 'singleton',
      tags: [DI_TAGS.CORE],
    });
  }
  ...
  if (!container.has(DI_TOKENS.SESSION_TOKEN_QUOTA)) {
    const { SessionTokenQuotaManager } =
      await import('../harness/constraints/SessionTokenQuota');
    container.register(
  ...
  if (!container.has(DI_TOKENS.SECURITY_POLICY_ENGINE)) {
    const { SecurityPolicyEngine } =
      await import('../security/SecurityPolicyEngine');
    container.register(
  ...
  if (!container.has(DI_TOKENS.SECURITY_GUARD)) {
    ...
    container.register(DI_TOKENS.SECURITY_GUARD, () => SecurityGuard.create(), {
      lifecycle: 'singleton',
      tags: [DI_TAGS.SECURITY],
      dependencies: [DI_TOKENS.SECURITY_POLICY_ENGINE],
    });
  ...
  if (!container.has(DI_TOKENS.SHELL_HOOKS)) {
    ...
    container.register(DI_TOKENS.SHELL_HOOKS, () => ShellHooks.create(), {
      lifecycle: 'singleton',
      tags: [DI_TAGS.SECURITY],
    });
  }
  ...
  if (!container.has(DI_TOKENS.MODEL_SELECTOR)) {
    ...
    container.register(DI_TOKENS.MODEL_SELECTOR, () => ModelSelector.create(), {
      lifecycle: 'singleton',
      tags: [DI_TAGS.MODEL],
    });
  }
  ...
  if (!container.has(DI_TOKENS.FILE_SYSTEM)) {
    ...
    container.register(DI_TOKENS.FILE_SYSTEM, () => FileSystem.create(), {
      lifecycle: 'singleton',
      tags: [DI_TAGS.INFRASTRUCTURE],
    });
  }
  ...
  if (!container.has(DI_TOKENS.I18N_MANAGER)) {
    ...
    container.register(DI_TOKENS.I18N_MANAGER, () => I18nManager.create(), {
      lifecycle: 'singleton',
      tags: [DI_TAGS.CORE],
    });
  }
  ...
  if (!container.has(DI_TOKENS.MCP_TOOL_BRIDGE)) {
    const { MCPToolBridge } =
      await import('../harness/tools/registry/MCPToolBridge');
    container.register(
  ...
  if (!container.has(DI_TOKENS.LSP_CLIENT_MANAGER)) {
    const { LspClientManager } =
      await import('../harness/lsp/LspClientManager');
    container.register(
  ...
  if (!container.has(DI_TOKENS.UNIFIED_CONTEXT_BUILDER)) {
    const { UnifiedContextBuilder } =
      await import('../harness/context/UnifiedContextBuilder');
    container.register(
  ...
  if (!container.has(DI_TOKENS.SKILL_REGISTRY)) {
    ...
    container.register(DI_TOKENS.SKILL_REGISTRY, () => SkillRegistry.create(), {
      lifecycle: 'singleton',
      tags: [DI_TAGS.HARNESS],
    });
  }
  ...
  if (!container.has(DI_TOKENS.PROFILE_TREND_ANALYZER)) {
    const { ProfileTrendAnalyzer } =
      await import('../user/ProfileTrendAnalyzer');
    container.register(
...
export function registerLLMProvider(llm: unknown): void {
  const container = DIContainer.getInstance();
  container.registerValue(DI_TOKENS.LLM_PROVIDER, llm, {
    tags: [DI_TAGS.MODEL],
  });
}
...
export function registerEventBus(eventBus: unknown): void {
  const container = DIContainer.getInstance();
  container.registerValue(DI_TOKENS.EVENT_BUS, eventBus, {
    tags: [DI_TAGS.CORE],
  });
}
