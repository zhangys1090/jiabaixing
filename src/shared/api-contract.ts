...
export const API_CONTRACT: ApiEndpoint[] = [
  ...
  {
    method: 'POST',
    path: '/api/mcp/servers/{name}/message',
    description: 'MCP 消息',
    tsImplemented: true,
    pyImplemented: true,
  },
  ...
  {
    method: 'POST',
    path: '/api/memory/store-short-term',
    description: '短期记忆',
    tsImplemented: true,
    pyImplemented: true,
  },
  {
    method: 'POST',
    path: '/api/memory/store-long-term',
    description: '长期记忆',
    tsImplemented: true,
    pyImplemented: true,
  },
  {
    method: 'POST',
    path: '/api/memory/store-episodic',
    description: '情节记忆',
    tsImplemented: true,
    pyImplemented: true,
  },
  {
    method: 'POST',
    path: '/api/memory/hybrid-retrieval',
    description: '混合检索',
    tsImplemented: true,
    pyImplemented: true,
  },
  ...
  {
    method: 'GET',
    path: '/api/memory/knowledge-graph',
    description: '知识图谱',
    tsImplemented: true,
    pyImplemented: true,
  },
  ...
  {
    method: 'POST',
    path: '/api/security/apikeys/rotate',
    description: 'API Key 轮换',
    tsImplemented: true,
    pyImplemented: false,
  },
  {
    method: 'POST',
    path: '/api/security/apikeys/revoke',
    description: 'API Key 撤销',
    tsImplemented: true,
    pyImplemented: false,
  },
];

export function getContractGaps(): {
  tsOnly: ApiEndpoint[];
  pyOnly: ApiEndpoint[];
  both: ApiEndpoint[];
} {
  const tsOnly = API_CONTRACT.filter(
    (e) => e.tsImplemented && !e.pyImplemented
  );
  const pyOnly = API_CONTRACT.filter(
    (e) => e.pyImplemented && !e.tsImplemented
  );
