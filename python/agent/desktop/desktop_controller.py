        ...
        if key in ("documents", "文档", "my_documents"):
            if os.name == "nt":
                try:
                    ...
                    log_ignored(logger, "desktop_controller.DesktopController.resolve_special_path", _exc)
    ...
    def _type_via_clipboard(self, text: str) -> ActionResult:
        ...
        try:
            ...
            try:
                ...
                log_ignored(logger, "desktop_controller.DesktopController._type_via_clipboard", _exc)
        ...
        try:
            if self._has_pywin32 and self._is_windows:
                ...
                try:
                    ...
                    log_ignored(logger, "desktop_controller.DesktopController.list_monitors", _exc)
        except Exception as e:
