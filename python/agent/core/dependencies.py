...
SUBSYSTEM_DEPS: list[SubsystemSpec] = [
    ...
    SubsystemSpec("plugin_manager", "_init_plugin_manager", ("tool_registry",), critical=False),
    # ── P3-P5 扩展节点 ──
    ...
    SubsystemSpec("threat_patterns", "_init_threat_patterns", critical=False),
    SubsystemSpec("memory_manager", "_init_memory_manager", critical=False),
    SubsystemSpec("insights", "_init_insights", critical=False),
    SubsystemSpec("background_review", "_init_background_review", critical=False),
    SubsystemSpec("conversation_compression", "_init_conversation_compression", critical=False),
    SubsystemSpec("context_references", "_init_context_references", critical=False),
    # ── P11 平台扩展+LSP+ACP+Skill节点 ──
    SubsystemSpec("platform_manager", "_init_platform_manager", critical=False),
    SubsystemSpec("lsp_servers", "_init_lsp_servers", critical=False),
    SubsystemSpec("lsp_workspace", "_init_lsp_workspace", critical=False),
    SubsystemSpec("acp_entry", "_init_acp_entry", critical=False),
    SubsystemSpec("acp_server", "_init_acp_server", critical=False),
    SubsystemSpec("acp_auth", "_init_acp_auth", critical=False),
    SubsystemSpec("skill_sync", "_init_skill_sync", critical=False),
    SubsystemSpec("skill_bundles", "_init_skill_bundles", critical=False),
    # ── P12 游离节点注册（原仅文件存在，未接入引擎生命周期） ──
    SubsystemSpec("model_cost_guard", "_init_model_cost_guard", ("llm",), critical=False),
    SubsystemSpec("auxiliary_client", "_init_auxiliary_client", ("llm",), critical=False),
    SubsystemSpec("moa_aggregator", "_init_moa_aggregator", ("llm",), critical=False),
    SubsystemSpec("streaming_scrubber", "_init_streaming_scrubber", critical=False),
    SubsystemSpec("account_usage", "_init_account_usage", critical=False),
    SubsystemSpec("learning_graph", "_init_learning_graph", critical=False),
