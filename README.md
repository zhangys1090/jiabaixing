...
> 完整 GIF / 录屏演示待补（当前为真实响应文本记录，详见下文 Demo 与真实验证）。
...
**核心链路真实打通**：T1 聊天 / T2 文件 / T3 记忆 / T4 代码分析 / T6 任务 / T7 日程 / T8 多步统计 / T10 验证 / T11 浏览器 / T12b 失败恢复 / T13 统计——全部经网关 3111 → WS → Python 3112 真实运行，结果可核验（如 `python/agent/tools` 共 59 个 .py，最大 `code_tools.py`；example.com 标题 `Example Domain`）。
